...
test('it build a styleReference for the componentPrefab backwards compatible', () => {
  const style = {
    name: 'Filled',
    overwrite: {
...
test('it build a styleReference for the componentPrefab for states', () => {
